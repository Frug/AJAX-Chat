...
1.	Upload to the server
	...
	Upload the chat folder to your server into your phpBB2 forum directory:
	e.g. http://example.org/phpBB2/chat/
...
2.	Creation of database tables
	...
	http://example.org/phpBB2/chat/install.php
	
	Replace "http://example.org/phpBB2/chat/" with the real URL to your chat directory.
